...
#Matrices de correlaciones creadas
matrix_cor_contenedores=cor(contenedores, method= "pearson")
ggcorrplot(matrix_cor_contenedores)

matrix_cor_contenedores_previo=cor(contenedores_previo, method="pearson")
ggcorrplot(matrix_cor_contenedores_previo)
...
contenedores_test$pred_lineal=as.numeric(contenedores_test$pred_lineal)
str(contenedores_test$TIEMPO_MEDIO_RECOGIDA)
str(contenedores_test$pred_lineal)
...
contenedores_test$pred_knn=as.numeric(contenedores_test$pred_knn)
str(contenedores_test$TIEMPO_MEDIO_RECOGIDA)
str(contenedores_test$pred_knn)
...
plot(arbol_training$finalModel, uniform = TRUE, margin =0.25)
text(arbol_training$finalModel, use.n = TRUE, all = TRUE, cex =0.5)
